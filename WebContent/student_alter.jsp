		...
		<form action="UpdateStu" method="post">
			<p>
				<span>姓名:&nbsp;&nbsp;</span> <input type="text" name="uname"
					value="<%=hs.getAttribute("name")%>"  autofocus
			...
			<p>
				<span>地址:&nbsp;&nbsp;</span> <input type="text" name="uaddress"
					value="<%=hs.getAttribute("address")%>" / required autofocus>
			</p>
			<p>
			...
			<p>
				<span>QQ:&nbsp;&nbsp;&nbsp;</span> <input type="uqq" name="uqq"
					value="<%=hs.getAttribute("qq")%>" / required autofocus>
			</p>
			<p class="tijiao">
