...
<body
	...
	<div class="double">
		...
		<ul id="nav" style="margin-left: 210px; margin-top: 90px;">
			<li style="width: 180px; height: 35px;"><a href="#"
				style="width: 180px; height: 27px; padding-top: 5px;">学生信息</a>
				<ul>
					<li><a href="student_show.jsp">查看个人信息</a></li>
					<li><a href="student_alter.jsp">修改个人信息</a></li>
					<li><a href="ShowCor_Stu">查看课程信息</a></li>
				</ul></li>
		</ul>
	</div>
